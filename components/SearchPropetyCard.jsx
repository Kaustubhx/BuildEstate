        ...
        <div className='bg-indigo-100 p-2 rounded-2xl'>
            <div className='space-y-4 lg:space-y-0 bg-white p-2 rounded-2xl lg:flex'>
                ...
                <div className='flex flex-col lg:ml-5 xl:ml-8 lg:flex-grow'>
                    <p className='text-indigo-500 font-semibold text-xl'>₹ 55,60,700</p>
                    <p className='font-semibold text-lg text-gray-500'>Lodha Amaze</p>
                    <p className='text-gray-500 font-semibold text-sm'>Balkum, Thane-West, Thane-400308</p>
